package android.com.example.udacityfourthproject.authentication

import android.app.Activity
import android.com.example.udacityfourthproject.R
import android.com.example.udacityfourthproject.databinding.ActivityAuthenticationBinding
        ...
        viewModel.authenticationState.observe(this) { authenticationState ->
            when (authenticationState) {
                LoginViewModel.AuthenticationState.AUTHENTICATED -> {
                    val activity = RemindersActivity::class.java
